...
//        01
        ...
        )
        {
            Column(
                ...
                Image(
                    painterResource(id = R.drawable.java), contentDescription = "",
                    modifier = Modifier
                        .height(150.dp)
...
//        02
        ...
        )
        {
            ...
            Image(
                painterResource(id = R.drawable.kotlin), contentDescription = "",
                modifier = Modifier
                    .height(150.dp)
...
//        03
        ...
        )
        {
            Column(
                ...
                Image(
                    painterResource(id = R.drawable.python), contentDescription = "",
                    modifier = Modifier
                        .height(150.dp)
                        .scale(scaleX = 1.2F, scaleY = 1F)
                )
...
//        04
        ...
        )
        {
            Column(
                ...
                Image(
                    painterResource(id = R.drawable.js), contentDescription = "",
                    modifier = Modifier
                        .height(150.dp)
                        .scale(scaleX = 1.2F, scaleY = 1F)
                )
